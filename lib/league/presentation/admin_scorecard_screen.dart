...
class AdminScorecardScreen extends ConsumerStatefulWidget {
  const AdminScorecardScreen({
    super.key,
  ...
  @override
  ConsumerState<AdminScorecardScreen> createState() =>
      _AdminScorecardScreenState();
}

class _AdminScorecardScreenState extends ConsumerState<AdminScorecardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Correct Scores'),
        actions: [
          IconButton(
